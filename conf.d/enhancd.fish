...
if ! set -q ENHANCD_ROOT
    if set -q fisher_data; set -gx ENHANCD_ROOT "$fisher_data/github.com/b4b4r07/$name"
    else set -gx ENHANCD_ROOT "$HOME/.local/share/fisher/github.com/b4b4r07/$name"; end; end
